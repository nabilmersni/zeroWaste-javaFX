...
public class UserProductDetailsController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            fxmlLoader1.setLocation(getClass().getResource("/gui/collectInterfaces/UserProductDetailsCard.fxml"));
    ...
    void add_new_comment(MouseEvent event) {
        ...
        if (value != 0) {
            ...
            Parent fxml;
            try {
                fxml = FXMLLoader.load(getClass().getResource("/gui/collectInterfaces/UserProductDetails.fxml"));
