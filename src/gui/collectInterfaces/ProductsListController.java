...
public class ProductsListController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        fxmlLoader1.setLocation(getClass().getResource("/gui/collectInterfaces/AddCategoryCard.fxml"));
        ...
        try {
            for (int i = 0; i < categories.size(); i++) {
                ...
                fxmlLoader.setLocation(getClass().getResource("/gui/collectInterfaces/OneCategoriesListCard.fxml"));
    ...
    private void setProductGridPaneList() {
        ...
        try {
            for (int i = 0; i < produits.size(); i++) {
                ...
                FXMLLoader fxmlLoader = new FXMLLoader();
                fxmlLoader.setLocation(getClass().getResource("/gui/collectInterfaces/OneProductListCard.fxml"));
