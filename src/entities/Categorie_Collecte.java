...
public class Categorie_Collecte {
    ...
    public static void setIdCategory(int idCategory) {
        Categorie_Collecte.idCategory = idCategory;
    }

    public Categorie_Collecte(int id, String nom_categorie, String image_categorie) {
      this.id = id;
      this.nom_categorie = nom_categorie;
      this.image_categorie = image_categorie;
    }

    public Categorie_Collecte() {
    }
